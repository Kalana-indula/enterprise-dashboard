...
export interface Invoice {
    ...
    name: string;
    email: string;
    cost: string; // keeping as string to match original data
    phone: string;
    date: string; // keeping as string (e.g. "03/12/2022")
}
...
export const mockTransactions: Transaction[] = [
    ...
    { txId: "0a123sb", user: "stevebower", date: "2022-11-02", cost: "13.55" },
    { txId: "01e4dsa", user: "aberdohnny", date: "2021-09-01", cost: "43.95" },
...
export const mockPieData: PieDatum[] = [
    { id: "hack", label: "hack", value: 239, color: "hsl(104, 70%, 50%)" },
    { id: "make", label: "make", value: 170, color: "hsl(162, 70%, 50%)" },
    { id: "go", label: "go", value: 322, color: "hsl(291, 70%, 50%)" },
    { id: "lisp", label: "lisp", value: 503, color: "hsl(229, 70%, 50%)" },
...
export const mockLineData: LineSeries[] = [
    {
        id: "japan",
        color: tokens("dark" as ThemeMode).greenAccent[500],
        data: [
            { x: "plane", y: 101 },
            { x: "helicopter", y: 75 },
            { x: "boat", y: 36 },
    ...
    {
        id: "france",
        color: tokens("dark" as ThemeMode).blueAccent[300],
        data: [
            { x: "plane", y: 212 },
            { x: "helicopter", y: 190 },
            { x: "boat", y: 270 },
    ...
    {
        id: "us",
        color: tokens("dark" as ThemeMode).redAccent[200],
        data: [
            { x: "plane", y: 191 },
            { x: "helicopter", y: 136 },
            { x: "boat", y: 91 },
...
export const mockGeographyData: GeographyDatum[] = [
    { id: "AFG", value: 520600 },
    { id: "AGO", value: 949905 },
    { id: "ALB", value: 329910 },
    { id: "ARE", value: 675484 },
