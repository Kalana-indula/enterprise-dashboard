...
export const mockLineData: LineSeries[] = [
    {
        id: "japan",
        color: tokens("dark").greenAccent[500] as unknown as string,
        data: [
            { x: "plane", y: 101 },
            { x: "helicopter", y: 75 },
            { x: "boat", y: 36 },
    ...
    {
        id: "france",
        color: tokens("dark").blueAccent[300] as unknown as string,
        data: [
            { x: "plane", y: 212 },
            { x: "helicopter", y: 190 },
            { x: "boat", y: 270 },
    ...
    {
        id: "us",
        color: tokens("dark").redAccent[200] as unknown as string,
        data: [
            { x: "plane", y: 191 },
            { x: "helicopter", y: 136 },
            { x: "boat", y: 91 },
...
export const mockGeographyData: GeographyDatum[] = [
    ...
    { id: "AUT", value: 798526 },
    { id: "AZE", value: 481678 },
    // ...keep the rest exactly the same values/shape...
    { id: "KOR", value: 171135 },
];
