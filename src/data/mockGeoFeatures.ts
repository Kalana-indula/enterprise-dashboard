...
type PolygonCoordinates = Position[][];        // [ [ [lng,lat], ... ], [hole...], ... ]
type MultiPolygonCoordinates = Position[][][]; // [ polygon[], polygon[], ... ]
...
export const geoFeatures: FeatureCollection = {
    // ✅ Paste your existing object content here EXACTLY as it is (no variable name changes)
    type: "FeatureCollection",
    features: [
        {
            type: "Feature",
